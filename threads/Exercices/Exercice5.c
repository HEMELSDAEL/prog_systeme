...
void *bonjour(void *arg){
  ...
  printf("Le thread Bonjour a terminé proprement son exécution\n");
  pthread_exit(NULL);
}
...
void *aurevoir(void *arg){
  ...
  printf("Le thread Au revoir a terminé proporement son exécution\n");
  pthread_exit(NULL);
}
...
int main(){
  ...
  printf("Tous les threads ont terminé proprement leur exécution\n");
